...
function EventCard(){
    ...
    return(
    <div className="card m-3 mx-auto" style={{maxWidth: '700px'}}>
  <div className="row g-0 " >
    {/* <div className="col-md-4  " style={{display: 'flex', justifyContent: 'center'}}> */}
    <div className="col-md-4 my-auto  " style={{height: '100%'}} >
      <img src="https://rpgrio.com.br/wp-content/uploads/2024/12/IniciativaRPG.png" className="img-fluid rounded-start"    alt="..."/>
    </div>
